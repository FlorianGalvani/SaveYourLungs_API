 ...
 */
final class Version20220308140957 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE Challenges (id INT AUTO_INCREMENT NOT NULL, user_id INT DEFAULT NULL, type VARCHAR(255) NOT NULL, state VARCHAR(255) NOT NULL, created_at DATE NOT NULL, updated_at DATE NOT NULL, expired_at DATE DEFAULT NULL, goal INT NOT NULL, INDEX IDX_48E8A430A76ED395 (user_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
