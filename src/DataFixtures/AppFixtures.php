    ...
    public function load(ObjectManager $manager): void
    {
        ...
        for ($i = 0; $i < 20; $i++) {
            ...
            $user->setFirstname($faker->firstName($gender))
                ...
                ->setRole('user')
                ->setCreatedAt($faker->dateTimeThisMonth($max = 'now', $timezone = null))
                ->setUpdatedAt($faker->dateTimeThisMonth($max = 'now', $timezone = null))
            ...
            if (!$isNewUser) {
                ...
                // Creation de  et liaison à l'utilisateur créer plus haut 
